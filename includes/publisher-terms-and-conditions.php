<?php
$t['title'] = 'Publisher terms & conditions';
?>
    ...
    <section class="section-content">
        <div class="container">
                ...
                <ol>
                    ...
                    <li>
                        <strong>Obligations of both Parties</strong>
                        <p>Subject to our acceptance of you as an affiliate and your continued compliance with the terms and conditions of this Agreement, MGine Digital LLC agrees as follows:</p>
                        <ol>
                        ...
                        <ol>
                            ...
                            <li>Not make any representations, warranties or other statements concerning MGine Digital LLC or Client or any of their respective products or services, except as expressly authorized herein.</li>
                            <li>Make sure that your Media does not copy or resemble the look and feel of the Program Web Site or create the impression that your Media is endorsed by MGine Digital LLC or Clients or a part of the Program Web Site, without prior written permission from us.</li>
                            ...
                            <li>Always prominently post and make available to end-users, including prior to the collection of any personally identifiable information, a privacy policy in compliance with all applicable laws that clearly and thoroughly discloses all information collection, use and sharing practices, including providing for the collection of such personally identifiable information in connection with the Affiliate Program and the provision of such personally identifiable information to MGine Digital LLC and Clients for use as intended by MGine Digital LLC and Clients.</li>
                            <li>Always prominently post and make available to end-users any terms and conditions in connection with the Offer set forth by MGine Digital LLC or Client, or as required by applicable laws regarding such Offers.</li>
                            <li>Make sure to not place MGine Digital LLC ads on any online auction platform (i.e. eBay, Amazon, Taobao, etc).</li>
                        </ol>
                        <p>The following additional program-specific terms shall apply to any promotional programs set forth below:</p>
                        <ol>
                            <li>Email Campaigns. For all email campaigns, Affiliate must download the "Suppression List" from the Offers section of MGine Digital LLC. Affiliate shall filter its email list by removing any entries appearing on the Suppression List and will only send emails to the remaining addresses on its email list. MGine Digital LLC will provide an opt-out method in all Links, however, if any opt-out requests come directly to Affiliate, Affiliate shall immediately forward them to MGine Digital LLC at contact@mgine.net. Affiliate's emails containing the Links may not include any content other than the Links, except as required by applicable law.</li>
                            <li>Affiliate agrees that failure to download the Suppression List and remove all emails from the database before mailing may result in Commission withholdings, removal or suspension from all or part of the Affiliate Program, possible legal action and any other rights or remedies available to MGine Digital LLC pursuant to this Agreement or otherwise. Affiliate further agrees that it will not mail or market to any suppression files generated through the MGine Digital LLC network, and that doing so may result in Commission withholdings, removal or suspension from the Affiliate Program, possible legal action and any other rights or remedies available to MGine Digital LLC pursuant to this Agreement or otherwise.</li>
                ...
                <p>We refer to the affiliate Terms located at <a href="/publisher-terms-and-conditions.html" target="_blank">“Agreement”</a> which You have accepted to avail Mgine Digital LLC’s advertising services as a affiliate (referred as “You” or “affiliate”).</p>
                ...
                <p>In the event of any Personal Data breach (actual or suspected) involving the affiliate or a sub-Processor, the affiliate shall (at no cost to Mgine Digital LLC):</p>
                <ul>
                ...
                <h3>Additional Provision</h3>

                <p>The illustrative indemnity contained in the Model Contract Clauses is deemed deleted.<br />
                    You will not provide any unsolicited data related to Data Subjects with us.</p>
                ﻿
